...
//myChart32.setOption(option32); // remove
mychartResourceCP.setOption(optionResourceCP);
mychartResourceShare.setOption(optionResourceShare);
//mychartDataStorage.setOption(optionDataStorage); // remove
//mychartDataShare.setOption(optionDataShare); // remove
//myChartAddCPU.setOption(optionAddCPU); // remove

...
var data2101x = ['行政许可审批', '环境监测报告', '法人基本信息', '市环保局公文', '全民社会保障'];
var data2101y = [23, 44, 30, 48, 64];
var data2102x = ['行政许可审批', '环境监测报告', '法人基本信息', '企业服务', '投资项目建设', '不动产登记', '企业注册登记', '企业纳税记录', '个人征信报告', '法人信用记录'];
var data2102y = [23, 44, 30, 48, 64, 41, 20, 22, 64, 41];
var data2103x = ['行政许可审批', '环境监测报告', '法人基本信息', '市环保局公文', '全民社会保障', '社会救助', '便民服务事项', '教育局公文', '财政局公文', '南京市公文', '江苏省公文', '工商登记', '企业服务', '投资项目建设', '不动产登记'];
var data2103y = [23, 44, 30, 48, 64, 41, 20, 22, 64, 41, 20, 22, 64, 41, 20];

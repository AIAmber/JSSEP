...
// 数据入库与利用
var optionDataStorage = {
    tooltip: {
        show: true,
        formatter: "{a} <br/>{b} : {c} 条 ({d}%)"
    },
    color: ['#5BB0F0', '#AED8F8', '#FFB880', '#FFE4CF'],
    series: [{
        name: '数据入库情况',
        type: 'pie',
        center: ['27%', '55%'],
...
//mychartDataStorage.setOption(optionDataStorage);
//mychartDataShare.setOption(optionDataShare);
...
setTimeout(function () {
    window.onresize = function () {
        ...
        myChart24.resize();
        myChart32.resize();
//        mychartDataStorage.resize();
//        mychartDataShare.resize();

...
<html lang="zh-CN">
<head>
	<title>目录审核-已审核</title>
</head>
<body>
	<script src="catalog/js/catalogalreadycheck.js"></script>
	<link href="catalog/css/catalog-form.css" rel="stylesheet">
	<form class="form-horizontal" method="post" id="catalogalreadycheck">
		<!-- 信息资源分类开始 -->
		<fieldset>
			<div class="hrtitle">
			...
			<div>
				...
				<div class="form-group">
					<label for="name" class="control-label formleft">资源摘要</label>
						<div class="col-sm-8">
						<textarea class="form-control forminput" name="resourceprovide">法人基本信息</textarea>
					</div>
				</div>
				<div class="form-group">
			...
			<div class="row clearfix">
				<div class="col-sm-12 column" style="text-align: center;">
					 <!-- <a class="btn btn-default btn-success btn-div" id="saveForm">
					 	<span class="bootstrap-dialog-button-icon glyphicon glyphicon-check"></span>&nbsp;审核
					 </a> -->
 	...
 	<div style="display: none">
		<div id="addInfo" class="btn-bottom">

...
<body>
	<script src="catalog/js/catalogmaintenanceinfoedit.js"></script>
	<link href="catalog/css/catalog-form.css" rel="stylesheet">
	<form class="form-horizontal" method="post" id="catalogmaintenanceinfoedit">
		<!-- 信息资源分类开始 -->
		<fieldset>
			<div class="hrtitle">
				...
				<div class="row">
					...
					<div class="col-md-12" id="relatebasis" style="display: none">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea class="form-control forminput" name="relatedbasis">违反相关法律法规</textarea>
							</div>
						</div>
					</div>
					<div class="col-md-12" id="sharebar" style="display: none;" >
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control forminput" name="sharingconditions" value="需要具备相应的访问权限" id="sharingconditions"></input>
							</div>
						</div>
					</div>
					<div class="col-md-12" id="sharerange" style="display: none">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control forminput" name="sharerange" id="sharerange" value="具备权限的所有人"></input>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12" id="otherInput" hidden="">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea rows="3" cols="" class="form-control forminput" name="sharingmethoddescription">共享方式说明</textarea>
							</div>
						</div>
					</div>
				</div>
	...
	<div style="display: none;">
		...
		<textarea class='form-control' id='catalogfailreasonone' name='catalogfailreasonone' style='margin-bottom:15px;'></textarea>" +
	</div>
</body>
</html>
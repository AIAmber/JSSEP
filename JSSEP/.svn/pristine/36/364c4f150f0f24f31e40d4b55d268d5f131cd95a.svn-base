...
<body>
	<script src="<%=path %>/catalog/js/newcatalogview.js"></script>
	<link href="<%=path %>/catalog/css/catalog-form.css" rel="stylesheet">
	<form class="form-horizontal" method="post" id="newcatalogview">
		<!-- 信息资源分类开始 -->
		<fieldset>
			<div class="hrtitle">
						...
						<div class="input-group">
						    ...
						    <select class="form-control formselect" name="classcify">
						    	<option value="">请选择类</option>
					   		    <option selected="selected">基础信息资源类</option>
						...
						<div class="input-group">
						    ...
						    <select class="form-control formselect" name="item">
						    	<option value="">请选择项</option>
						   		<option selected="selected">法人单位信息资源库</option>
						   		<option>审批改革</option>
			...
			<div>
				...
				<div class="form-group">
					<label for="name" class="control-label formleft"><font class="red">*</font>资源摘要</label>
						<div class="col-sm-8">
						<textarea class="form-control forminput" name="resourcesummary">3550主题分析-企业注册登记</textarea>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12" id="relatebasis" hidden="">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea class="form-control forminput" name="relatedbasis"></textarea>
							</div>
						</div>
					</div>

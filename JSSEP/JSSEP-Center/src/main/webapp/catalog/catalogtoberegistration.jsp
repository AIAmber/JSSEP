...
<html lang="zh-CN">
<head>
	<title>目录注册-待注册</title>
</head>
<body>
	<script src="<%=path %>/catalog/js/catalogtoberegistration.js"></script>
	<link href="<%=path %>/catalog/css/catalog-form.css" rel="stylesheet">
	<form class="form-horizontal" method="post" id="catalogtoberegistration">
		<!-- 信息资源分类开始 -->
		<fieldset>
			<div class="hrtitle">
			...
			<div class="">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control forminput" name="resourcename" value="办件信息">
					</div>
				</div>
			</div>
		</fieldset>
 		...
 		<fieldset>
			...
			<div>
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" class="form-control forminput" name="resourceprovide" id="resourceprovider" readonly="readonly" placeholder="请选择资源提供方" value="市质监局">
				...
				<div class="form-group">
					<label for="name" class="control-label formleft"><font class="red">*</font>资源摘要</label>
						<div class="col-sm-8">
						<textarea class="form-control forminput" name="resourcesummary" rows="3">办件信息</textarea>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-md-12" id="sharebar" style="display: none;" >
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control forminput" name="sharingconditions" id="sharingconditions" value="需要具有相应的权限"></input>
							</div>
						</div>
					</div>
					<div class="col-md-12" id="sharerange" style="display: none">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control forminput" name="sharerange" id="sharerange" value="部分共享"></input>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12" id="otherInput" hidden="">
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea rows="3" cols="" class="form-control forminput" name="sharingmethoddescription">可以通过特定的方式单独请求获取相应的数据</textarea>
							</div>
						</div>
					</div>
				</div>
	...
	<div style="display: none;">
		...
		<!-- 注册失败原因弹出框内容 -->
		<textarea class="form-control" id="catalogfailreasonone" name="catalogfailreasonone" style="margin-bottom:15px;" placeholder="请输入退回原因" rows="5"></textarea>
	</div>
</body>
</html>
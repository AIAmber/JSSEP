...
<html lang="zh-CN">
<head>
	<title>目录发布-待发布</title>
</head>
<body>
	<script src="catalog/js/catalogtobereleased.js"></script>
								...
								<div class="col-sm-8">
									...
									<table class="table table-hover">
										...
										<tbody id="resourceformatchoice">
											<tr>
												<td><input type="checkbox" name="resformat"></td>
												<td>电子文件</td>
											...
											<tr>
												<td>
													<input type="checkbox" name="resformat">
												</td>
												<td>电子表格</td>
												<td>ET,XLS,XLSX</td>
												<td><a href="javascript:void(0);" onclick="$(this).parent().parent().remove();" class="glyphicon glyphicon-trash"></a></td>
						 	...
						 	<div class="col-sm-8">
								...
								<tbody id="infoItemTable">
									...
									<tr>
										...
										<td>信息项名称</td><td>文本类信息</td><td>标明所采用的字符集和编码方式， 推荐使用</td>
										<td><a href="javascript:void(0);" onclick="$(this).parent().parent().remove();" class="glyphicon glyphicon-trash"></a></td>
									</tr>
									<tr>
										<td><input type="checkbox" name="ids"></td>
...
<!-- 								<div style="height: 800px" class="modal fade" id="addInfo" tabindex="-1" role="dialog" aria-labelledby="addInfoLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
 -->									
 		...
 		<fieldset>
	      	<div class="hrtitle">
	      		<img alt="" src="common/img/list-title.png" style="margin-top: -5px;">
	      		<span style="margin-left: 10px">属性</span>
	      	</div>
			<hr>
			<div class="container">
				<div class="row">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label for="name" class="col-sm-1 control-label">开放属性</label>
							<div class="col-sm-9">
								<label class="radio-inline">
		...
		<!-- 审核结果结束-->
   	 	...
   	 	<fieldset>
	      	<div class="hrtitle">
	      		<img alt="" src="common/img/list-title.png" style="margin-top: -5px;">
	      		<span style="margin-left: 10px">发布结果</span>
	      	</div>
			<hr>
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label for="resourcename" class="col-sm-1 control-label">结果</label>
							<div class="col-sm-2">
					...
					<div class="col-md-12" id="resultreason" style="display: none;">
						<div class="form-group">
							<label for="resourcename" class="col-sm-1 control-label">原因</label>
							<div class="col-sm-2">
								<select class="form-control" id="shareType">
   							   		<option>不通过原因1</option>
   							   		<option>不通过原因2</option>
   							   		<option>不通过原因n</option>
							   </select>
							</div>
						</div>
					</div>
			...
			<div class="row clearfix">
				<div class="col-sm-12 column" style="text-align: center;">
					 <button type="button" class="btn btn-default btn-primary">发布</button>
					 <button type="button" class="btn btn-default btn-warning">退回</button>
				</div>
			</div>
		</div>
 		<!-- 其他结束 -->

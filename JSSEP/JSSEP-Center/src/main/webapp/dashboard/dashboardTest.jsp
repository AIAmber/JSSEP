...
<body>
	<script type="text/javascript" src="<%=path %>/dashboard/js/dashboardTest.js"></script>
            ...
            <div class="row" style="padding-left: 16px; padding-right: 16px;">
                ...
                <div class="col-md-4 col-xs-4">
                    <div class="panel panel-default" style="border-color: #9FD3A2; box-shadow: none;">
                        ...
                        <div class="panel-body" style="background-color: #81C884; text-align: center; margin: 0 auto;">
                            ...
                            <div>
                                <div style="height: 68px; width: 35%;  float: right;">
                                    ...
                                    <p style="font-size: 30px; color: white; margin-top: -4px"><span id="cardAb">12</span><span id="cardAb-bit" style="font-size: 18px">&nbsp;条</span></p>
                                </div>
                                <div style="height: 68px; width: 35%;  float: right;">
                                    <p style="font-size: 13px; color: white; display: block; margin-top: -6px">已发布</p>
                                    <p style="font-size: 30px; color: white; margin-top: -4px"><span id="cardAa">157</span><span id="cardAa-bit" style="font-size: 18px">&nbsp;条</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-xs-4">
                    <div class="panel panel-default" style="border-color: #FFC878; box-shadow: none;">
                        ...
                        <div class="panel-heading" style="height: 32px; background-color: #FFC878; border-color: #FFB74E; text-align:center; font-size: 16px; color: white;">
                            <span style="display: block; margin-top: -4px">部门接入情况</span>
                        </div>
                        <div class="panel-body" style="background-color: #FFB74E; text-align: center; margin: 0 auto;">
                            <div style="height: 68px; width: 30%; float: left;">
                            ...
                            <div>
                                <div style="height: 68px; width: 35%;  float: right;">
                                    <p style="font-size: 13px; color: white; display: block; margin-top: -6px">接入部门占比</p>
                                    <p style="font-size: 24px; color: white; margin-top: 7px"><span id="cardBa">23%</span></p>
                                </div>
                                <div style="height: 68px; width: 35%;  float: right;">
                                    <p style="font-size: 13px; color: white; display: block; margin-top: -6px">已接入部门</p>
                        ...
                        <div class="panel-body" style="background-color: #4DB7AD; text-align: center; margin: 0 auto;">
                            ...
                            <div>
                                <div style="height: 68px; width: 35%;  float: right;">
                                    ...
                                    <p style="font-size: 24px; color: white; margin-top: 7px;"><span id="cardCb">18.12</span><span id="cardCb-bit" style="font-size: 18px">&nbsp;G</span></p>
                                </div>
                                <div style="height: 68px; width: 35%;  float: right;">
                                    <p style="font-size: 13px; color: white; display: block; margin-top: -6px">交换次数</p>
                                    <p style="font-size: 24px; color: white; margin-top: 7px;"><span id="cardCa">15,324</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-8 col-xs-8">
                    <div class="panel panel-default" style="border-radius: 2px; border-color: white; box-shadow: none;">
                        <div class="panel-heading" style="height: 36px; background-color: #f5f5f4; border-color: #f5f5f4;">
                            ...
                            <!--"更多"按钮-->
                            <div style="position: relative; width: 32px; margin-top: -3px; padding: 0px 8px; float: right;">
                                <button type="button" class="btn btn-default btn-circle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color: #fff"><i class="glyphicon glyphicon-option-horizontal" style="margin-left: -1px; color: #ccc"></i></button>
                                <ul class="dropdown-menu">
                                    <li><a id="dash-count-top5" style="color: #333">TOP 5</a></li>
                                    <li><a id="dash-count-top10" style="color: #333">TOP 10</a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- 第2排第1个 -->
                ...
                <div class="col-md-4 col-xs-4">
                    <div class="panel panel-default" style="border-radius: 2px; border-color: white; box-shadow: none;">
                        <div class="panel-heading" style="height: 36px; background-color: #f5f5f4; border-color: #f5f5f4;">
                            ...
                            <span style="font-size:16px; float: left; width: 150px; line-height: 16px;">资源交换分类占比</span>
                        </div>
                        <!-- 第2排第2个 -->
                        <div class="panel-body">
                            <!-- 资源交换占比 -->
                            <div id="mainResourceCP" style="height:234px"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-8 col-xs-8">
                    <div class="panel panel-default" style="border-radius: 2px; border-color: white; box-shadow: none;">
                        <div class="panel-heading" style="height: 36px; background-color: #f5f5f4; border-color: #f5f5f4;">
                            ...
                            <!--"更多"按钮-->
                            <div style="position: relative; width: 32px; margin-top: -3px; padding: 0px 8px; float: right;">
                                <button type="button" class="btn btn-default btn-circle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="glyphicon glyphicon-option-horizontal" style="margin-left: -1px; color: #ccc"></i></button>
                                <ul class="dropdown-menu">
                    ...
                    <div class="col-md-4 col-xs-4">
                        <div class="panel panel-default" style="border-radius: 2px; border-color: white; box-shadow: none;">
                            <div class="panel-heading" style="height: 36px; background-color: #f5f5f4; border-color: #f5f5f4;">
                                ...
                                <span style="font-size:16px; float: left; width: 100px; line-height: 16px;">资源共享情况</span>
                            </div>
                            <!-- 第3排第2个 -->
                            <div class="panel-body">
                                <div id="mainResourceShare" style="height:234px"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row-fluid">
                    <div class="col-md-4 col-xs-4">
                        <div class="panel panel-default" style="border-radius: 2px; border-color: white; box-shadow: none;">
                            <div class="panel-heading" style="height: 36px; background-color: #f5f5f4; border-color: #f5f5f4;">
                                <span style="font-size:16px; float: left; width: 24px; height: 36px; color: #5f5f5f; display: block; margin-top: -2px"><i class="glyphicon glyphicon-indent-left"></i></span>
                                <span style="font-size:16px; float: left; width: 100px; line-height: 16px;">部门交换情况</span>
                                <div style="position: relative; width: 24px; margin-top: -3px; float: right;">
                                    <button id="dash-reqPub-rank" type="button" class="btn btn-default btn-circle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="glyphicon glyphicon-option-horizontal" style="margin-left: -1px; color: #ccc"></i></button>
                                    <ul class="dropdown-menu">
                                        <li><a id="dash-request-top5" style="color: #333">TOP 5</a></li>
                                        <li><a id="dash-request-top8" style="color: #333">TOP 10</a></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- 第4排第1个echarts -->
                            <div class="panel-body">
                                <div id="mainDepartExchange" style="height:204px"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-8 col-xs-8">
                    <div class="panel panel-default" style="border-radius: 2px; border-color: white; box-shadow: none;">
                        ...
                        <div class="panel-heading" style="height: 36px; background-color: #f5f5f4; border-color: #f5f5f4;">
                            ...
                            <span style="font-size:16px; float: left; width: 100px; line-height: 16px;">系统运行情况</span>
                        </div>
                        <!-- 第4排第2个 -->
                        <div class="panel-body">
                            <div id="mainSystemRun-Machine" style="height:204px; width: 44%;  float:left;">
                                <table class="table table-condensed table-hover">
                                    <thead>
                                        <tr>
                                            <th style="border-bottom-color: #fff; color: #DA9631;">主机服务</th>
                                        </tr>
                                        <tr>
                                            <th style="border-bottom-color: #FFDBA6; border-top-color: #fff;">节点IP</th>
                                            <th style="border-bottom-color: #FFDBA6; border-top-color: #fff;">内存</th>
                                            <th style="border-bottom-color: #FFDBA6; border-top-color: #fff;">CPU</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                    ...
                                    <thead>
                                        <tr>
                                            <th style="border-top-color: #fff; border-bottom-color: #fff; color: #81C784;">存储服务</th>
                                        </tr>
                                        <tr>
                                            <th style="border-bottom-color: #C0E3C1; border-top-color: #fff;">节点IP</th>
                                            <th style="border-bottom-color: #C0E3C1; border-top-color: #fff;">内存</th>
                                            <th style="border-bottom-color: #C0E3C1; border-top-color: #fff;">CPU</th>
                                            <th style="border-bottom-color: #C0E3C1; border-top-color: #fff;">存储量</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                            ...
                            <div id="mainSystemRun-Exchange" style="height:204px; width: 53%; float:right;">
                                <table class="table table-condensed table-hover">
                                    <thead>
                                        <tr>
                                            <th style="border-bottom-color: #fff; color: #5AB1EF;">交换服务</th>
                                        </tr>
                                        <tr>
                                            <th style="border-bottom-color: #ACD8F7; border-top-color: #fff;">节点IP</th>
                                            <th style="border-bottom-color: #ACD8F7; border-top-color: #fff;">内存</th>
                                            <th style="border-bottom-color: #ACD8F7; border-top-color: #fff;">CPU</th>
                                            <th style="border-bottom-color: #ACD8F7; border-top-color: #fff;">总交换量</th>
                                            <th style="border-bottom-color: #ACD8F7; border-top-color: #fff;">队列剩余</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>

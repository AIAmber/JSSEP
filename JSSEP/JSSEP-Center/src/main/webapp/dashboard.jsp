...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading clearfix">
                                        <i class="glyphicon glyphicon-send"></i> 最新发布目录内容
                                        <div class="btn-group btn-group-sm pull-right table-toolbar-btn-group">
                                            <!--<span class='glyphicon glyphicon-option-vertical'></span>-->
                                            <button id="btn-delete" type="button" class="btn btn-default">详情</button>
                                        </div>
                                    </div>
                                    <!-- 第1排第1个 -->
                                    <div class="panel-body">
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading clearfix">
                                        <i class="glyphicon glyphicon-list-alt"></i> 最新发布内容统计
                                        <div class="btn-group btn-group-sm pull-right table-toolbar-btn-group">
                                            <!--<span class='glyphicon glyphicon-option-vertical'></span>-->
                                            <button id="btn-delete" type="button" class="btn btn-default">详情</button>
                                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading clearfix">
                                        <i class="glyphicon glyphicon-bookmark"></i> 热门资源访问统计
                                        <div class="btn-group btn-group-sm pull-right table-toolbar-btn-group">
                                            <!--<span class='glyphicon glyphicon-option-vertical'></span>-->
                                            <button id="btn-delete" type="button" class="btn btn-default">详情</button>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading clearfix">
                                        <i class="glyphicon glyphicon-retweet"></i> 今日资源交换量统计
                                        <div class="btn-group btn-group-sm pull-right table-toolbar-btn-group">
                                            <!--<span class='glyphicon glyphicon-option-vertical'></span>-->
                                            <button id="btn-delete" type="button" class="btn btn-default">详情</button>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading clearfix">
                                        <i class="glyphicon glyphicon-signal"></i> 资源访问次数统计
                                        <div class="btn-group btn-group-sm pull-right table-toolbar-btn-group">
                                            <!--<span class='glyphicon glyphicon-option-vertical'></span>-->
                                            <button id="btn-delete" type="button" class="btn btn-default">详情</button>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    <div class="panel-heading clearfix">
                                        <i class="glyphicon glyphicon-th"></i> 请求类型分析
                                        <div class="btn-group btn-group-sm pull-right table-toolbar-btn-group">
                                            <!--<span class='glyphicon glyphicon-option-vertical'></span>-->
                                            <button id="btn-delete" type="button" class="btn btn-default">详情</button>
                                        </div>
                                            ...
                                            <div id="main42" style="height:250px; overflow-x:hidden; overflow-y:auto;">
                                                ...
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>Slave-02</td>
                                                            <td>Linux(114.55.34.132) </td>
                                                            <td>Centos 7.3</td>
                                                            <td>00-00-00-00-00-00-00-F1</td>
                                                            <td>21</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Slave-03</td>
    ...
    <script type="text/javascript" src="common/echarts/echartsAll.js"></script>

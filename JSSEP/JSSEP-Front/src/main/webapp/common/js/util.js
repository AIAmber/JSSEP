define(['bootstrap-dialog'],function(BootstrapDialog){
	...
	return {
			...
			infoDialog:function(message,func){
				BootstrapDialog.show({
			        title: '系统提示',
			        message: '<span class="col-sm-2 glyphicon glyphicon-info-sign text-info"></span><span class="col-sm-10 message">'+message+'</span>',
			...
			questionDialog:function(message,func){
				BootstrapDialog.show({
			        title: '系统提示',
			        message: '<span class="col-sm-2 glyphicon glyphicon-question-sign text-info"></span><span class="col-sm-10 message">'+message+'</span>',
			        type: BootstrapDialog.TYPE_INFO,
			        cssClass:'message-dialog',
			        closeByBackdrop: false,
		        	closeByKeyboard: false,
			...
			dangerDialog:function(message,func){
				BootstrapDialog.show({
			        title: '系统提示',
			        message: '<span class="col-sm-2 glyphicon glyphicon-remove-sign"></span><span class="col-sm-10 message">'+message+'</span>',
			...
			successDialog:function(message,func){
				BootstrapDialog.show({
			        title: '系统提示',
			        message: '<span class="col-sm-2 fa fa-check-circle"></span><span class="col-sm-10 message">'+message+'</span>',
